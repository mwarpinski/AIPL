...
- **[Hacker News Engine](file:///home/matt/Projects/Repos/AIPL/examples/hn_clone/hn_full_engine.aipl)**: Complete web application backend with user registration, authentication, security password hashing, and story submission written in AIPL.
